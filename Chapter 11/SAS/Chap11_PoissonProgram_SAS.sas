/*Sample Poisson Data;*/
data a;
input Obs a b cp n reps i x m mu_x_m y;
if x gt 0 then xd=1;
if x le 0 then xd=0;
x=xd;
mround=round(m,4)/4;
m=mround+3;
cards;
1 4 0.3 0 100 1 1 -0.42098 -2.0496 0.5407 0 
2 4 0.3 0 100 1 2 -1.57868 -6.5818 0.1388 0 
3 4 0.3 0 100 1 3 1.61346 8.4228 12.5140 13 
4 4 0.3 0 100 1 4 -0.32113 -1.0594 0.7277 0 
5 4 0.3 0 100 1 5 0.24357 -1.2336 0.6907 1 
6 4 0.3 0 100 1 6 -0.23699 -1.5456 0.6290 0 
7 4 0.3 0 100 1 7 -1.06334 -3.2964 0.3720 0 
8 4 0.3 0 100 1 8 -0.40957 -2.4835 0.4747 0 
9 4 0.3 0 100 1 9 -0.12468 -1.7809 0.5861 0 
10 4 0.3 0 100 1 10 -0.45697 -2.0597 0.5391 1 
11 4 0.3 0 100 1 11 1.37277 5.3675 5.0041 3 
12 4 0.3 0 100 1 12 0.11634 1.9629 1.8019 0 
13 4 0.3 0 100 1 13 -0.28561 -0.8864 0.7665 0 
14 4 0.3 0 100 1 14 -1.11235 -6.5605 0.1397 0 
15 4 0.3 0 100 1 15 1.06512 2.4341 2.0755 3 
16 4 0.3 0 100 1 16 -0.53912 -3.5288 0.3469 0 
17 4 0.3 0 100 1 17 0.01051 -0.3040 0.9128 1 
18 4 0.3 0 100 1 18 -0.06296 -0.6605 0.8203 0 
19 4 0.3 0 100 1 19 1.16836 3.4238 2.7931 2 
20 4 0.3 0 100 1 20 0.59453 2.6274 2.1995 5 
21 4 0.3 0 100 1 21 -0.61233 -1.9087 0.5641 2 
22 4 0.3 0 100 1 22 1.14072 3.3241 2.7107 3 
23 4 0.3 0 100 1 23 2.39160 8.3322 12.1785 8 
24 4 0.3 0 100 1 24 -0.56468 -3.0760 0.3974 1 
25 4 0.3 0 100 1 25 -1.59937 -6.7372 0.1325 0 
26 4 0.3 0 100 1 26 -1.00862 -3.6968 0.3299 1 
27 4 0.3 0 100 1 27 3.03097 11.3988 30.5587 33 
28 4 0.3 0 100 1 28 -0.51952 -2.8030 0.4313 0 
29 4 0.3 0 100 1 29 -1.25954 -4.3382 0.2721 0 
30 4 0.3 0 100 1 30 -1.47776 -5.6214 0.1852 0 
31 4 0.3 0 100 1 31 -0.74563 -4.4389 0.2640 0 
32 4 0.3 0 100 1 32 0.76926 1.0418 1.3669 0 
33 4 0.3 0 100 1 33 1.08691 4.0295 3.3496 0 
34 4 0.3 0 100 1 34 -1.10666 -3.2115 0.3816 0 
35 4 0.3 0 100 1 35 0.81011 4.3163 3.6506 2 
36 4 0.3 0 100 1 36 -1.54567 -5.4264 0.1963 0 
37 4 0.3 0 100 1 37 0.18557 1.8494 1.7416 0 
38 4 0.3 0 100 1 38 0.62864 4.6063 3.9824 4 
39 4 0.3 0 100 1 39 -0.39377 -1.1369 0.7110 2 
82 4 0.3 0 100 1 82 -0.20311 0.3831 1.1218 1 
83 4 0.3 0 100 1 83 1.13926 3.8720 3.1950 0 
84 4 0.3 0 100 1 84 -1.26655 -5.9607 0.1673 0 
85 4 0.3 0 100 1 85 -1.08019 -3.9008 0.3103 0 
86 4 0.3 0 100 1 86 -0.38003 0.2297 1.0713 0 
87 4 0.3 0 100 1 87 -0.33048 -0.9445 0.7533 1 
88 4 0.3 0 100 1 88 -0.73046 -1.3472 0.6675 0 
89 4 0.3 0 100 1 89 -1.08982 -4.1694 0.2863 1 
90 4 0.3 0 100 1 90 0.50636 2.5835 2.1707 0 
91 4 0.3 0 100 1 91 0.25421 0.9313 1.3223 0 
92 4 0.3 0 100 1 92 0.57184 3.6442 2.9840 1 
93 4 0.3 0 100 1 93 0.74718 4.1511 3.4740 5 
94 4 0.3 0 100 1 94 -0.26352 -1.2584 0.6856 1 
95 4 0.3 0 100 1 95 -0.16883 0.9820 1.3426 3 
96 4 0.3 0 100 1 96 0.30188 1.2606 1.4596 1 
97 4 0.3 0 100 1 97 0.80651 5.0654 4.5705 3 
98 4 0.3 0 100 1 98 -1.23875 -5.0542 0.2195 0 
99 4 0.3 0 100 1 99 -0.22096 -0.2593 0.9252 0 
100 4 0.3 0 100 1 100 2.39389 9.7004 18.3591 23 
;
data data; set a;
keep x m y;
*mediation analysis*;
...
ciu=J(1,12);
				...
				%if (&mreg=logistic & &yreg=logistic) %then %do;
					%do j=1 %to 12;
se[,&j]=sqrt(gamma[&j,]*sigma*t(gamma[&j,]));
					%end;
				%end;
				%if (&mreg=linear & &yreg=linear) | (&mreg=linear & &yreg=logistic) %then %do;
					%do j=1 %to 12;
se[,&j]=sqrt(gamma[&j,]*sigma*t(gamma[&j,]))*abs(&a1-&a0);
					%end;
				%end;
...
append from x;
run;
name='cde' || 'nde'||'nie'||'marginal total effect';
name=t(name);
cname2= {"Effect"};
create x4 from name [colname=cname2];
append from name;
...
%if &yreg=loglinear | &yreg=poisson | &yreg=negbin %then %do;
proc datasets library=work;
...
%mediation(data=data,yvar=y,avar=x,mvar=m,cvar=,a0=0,a1=1,m=0,nc=0,yreg=poisson,mreg=linear,
interaction=false,casecontrol=,output=full,c=,boot=false);
run;
%mediation(data=data,yvar=y,avar=x,mvar=m,cvar=,a0=0,a1=1,m=0,nc=0,yreg=negbin,mreg=linear,
interaction=true,casecontrol=,output=full,c=,boot=false);
run;
proc means data=data mean var skew kurtosis; var x m y;run;
proc print data=data;run;
proc freq data=data; table m*y;run;
data new; set data; new=x*1000+m*100+y;
proc freq data=new; tables new;
proc genmod data=data; model y =x m/dist=Poisson link=log;
proc genmod data=data; model y =x|m/dist=Poisson link=log;
proc genmod data=data; model y =x/dist=Poisson link=log;
proc genmod data=data; model y =x m/dist=negbin link=log;
proc genmod data=data; model y =x|m/dist=negbin link=log;
proc genmod data=data; model y =x/dist=negbin link=log;
run;
