...
data total;
do sequence=1 to 973;
output;
rename sequence = obs;
end;
run;

data Star1; set Starfreq;
do i=1 to count;
if all3 = 0 then do x=0; m=0; y=0; end;
if all3 = 1 then do x=0; m=0; y=1; end;
if all3 = 10 then do x=0; m=1; y=0; end;
if all3 = 11 then do x=0; m=1; y=1; end;
if all3 = 100 then do x=1; m=0; y=0; end;
if all3 = 101 then do x=1; m=0; y=1; end;
if all3 = 110 then do x=1; m=1; y=0; end;
if all3 = 111 then do x=1; m=1; y=1; end;
output;
end;
drop i all3 count;
run;

data data; merge star1 total; run;
proc freq data=data;table x*m*y; run;
...
%mediation(data=data,yvar=y,avar=x,mvar=m,cvar=,a0=0,a1=1,m=0,nc=0,yreg=logistic,mreg=logistic,
